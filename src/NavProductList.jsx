...
import "./NavProductList.css";
import CartItem from "./CartItem";

function NavProductList(props) {
 ...
 position: "absolute",
  left: "50%",
  top: "50%", // vertically align in navbar
    ...
    <div>
      <div className="navbar" style={styleObj}>
        ...
        <div style={styleObjUl}>
          <div>
            {" "}
            <a href="#" onClick={(e) => handlePlantsClick(e)} style={{...styleA,...centerLinkStyle}}>
              Plants
            </a>
          </div>
          <div>
